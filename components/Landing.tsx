...
export default function Landing() {
    return (
        <div
            ...
            className="p-4 max-w-5xl w-full mx-auto"
        >
            <ThemeToggle />
            ...
            <p className="dark:text-zinc-400">
                Nova is an AI powered chatbot designed to engage users in
                meaningful conversations using{" "}
                <Link
                    href={"https://ai.google.dev/"}
                    target="_blank"
                ...
                . From answering queries to providing personalized
                recommendations, Nova leverages advanced natural language
                processing to deliver insightful and efficient interactions,
                making it a versatile digital assistant.
            </p>
        </div>
    );
}
